						...
						<div className="flex items-center gap-3">
							...
							<div>
								...
								<p className="text-stone-600 font-light">
									Manage your ingredients and discover what
									you can cook
								</p>
							</div>
						</div>
								...
								{itemsData.scansLimit === "unlimited" ? (
									...
									<PricingModal>
										<span className="text-stone-500 cursor-pointer">
											Upgrade to Pro for unlimited Pantry
											scans
										</span>
									</PricingModal>
								)}
							...
							<div className="flex items-center gap-4">
								...
								<div className="flex-1">
									...
									<p className="text-green-100 text-sm font-light">
										Get AI-powered recipe suggestions from
										your {items.length} ingredients
									</p>
								</div>
				...
				{!loadingItems && items.length === 0 && (
					<div className="bg-white p-12 text-center border-2 border-dashed border-stone-200">
						...
						<p className="text-stone-600 mb-8 max-w-md mx-auto font-light">
							Start by scanning your pantry with AI or adding
							ingredients manually to discover amazing recipes!
						</p>
						<Button
							onClick={() => setIsModalOpen(true)}
